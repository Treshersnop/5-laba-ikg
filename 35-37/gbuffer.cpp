...
//Перед началом кажого кадра мы должны очистить итоговую текстуру
...
//для изменения FBO мы задаем буферы для записи каждый раз
...
//Назначаем целью итоговый буфер и привязываем аттрибуты буфера как источник
...
//Здесь мы настраиваем блиттинг, который осуществляется в главном коде.FBO по - умолчанию ставим целью, 
//а FBO G буфера - источником
