...
bool Mesh::InitFromScene(const aiScene* pScene, const string& Filename)//создает и заполняет различные VBs меша данными вершин
{
...
//принимает 2 массива матриц - матрицы WVP и мировых преобразований
